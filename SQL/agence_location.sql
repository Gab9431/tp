...
--
-- Hôte : localhost
-- Généré le : ven. 21 nov. 2025 à 13:12
...
(1, 'macron', 'emmanuel', '0745236820', 'emmanuel@gmail.fr', 'Elysee'),
(2, 'Martin', 'JenLuc', '066944593', 'JenLuc@gmail.fr', 'Paname');
...
(1, 'messi', 'Fatima', 'Caissier', 999999),
(2, 'Halland', 'frank', 'Caissier', 0.8);
...
(1, 2, 2, 1, '2025-11-01', '2025-11-02', 22852),
(2, 1, 1, 2, '2025-11-01', '2025-11-10', 425);
...
(1, 'ESFEF457HHT', 'Volkswagen', 'Golf 8 R', 2020, 522, 1),
(2, 'SGE42587GR', 'Audi', 'Audi R8', 2021, 4257, 2);
